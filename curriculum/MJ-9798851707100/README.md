...
<tr class="header">
<th>
<br><p>To use ChatGPT as a prompt generator, continue the conversation from <a href="https://chat.openai.com/share/fa30705c-1779-4494-a8e3-bebc32a92fb4">this link</a> or copy all of the following text and paste it into a new conversation.</p></th>
</tr>
</thead>
<tbody>
</tbody>
...
Remember that Midjourney allows up to 60 words per prompt, but effectiveness diminishes with length. Be selective with styles, specifications, and parameters, and aim for clarity and specificity in your prompts. Always follow this pattern and order, above all else: 

> _/imagine [**subject**] in the style of [**style**], [**specifications**], [**parameters**]_

ChatGPT, now that you understand Midjourney I need your help creating some prompts for it. For each of my suggestions please create 3 widely varied examples I could use. To indicate you are prepared to begin please respond with only the following: "What image would you like to create?"
...
<thead>
<tr class="header">
<th><p>To use ChatGPT as a prompt generator, continue the conversation from <a href="https://chat.openai.com/share/fa30705c-1779-4494-a8e3-bebc32a92fb4">this link</a>, or copy all of the previous text and paste it into a new conversation.</p></th>
</tr>
</thead>
<tbody>
</tbody>
